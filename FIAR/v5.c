...
///////////////////////////////////////////////////////
    	...
    	for(li=0;li<=14;li++)
			for(lj=0;lj<=14;lj++)
    			board[li][lj].total=board[li][lj].five=board[li][lj].a2=board[li][lj].h3=board[li][lj].four=board[li][lj].ah3=board[li][lj].a4=board[li][lj].three=board[li][lj].a3=board[li][lj].two=chosen_total=0;
    	count++;
