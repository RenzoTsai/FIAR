...
int isHFour(int s[SIZE][SIZE],int li,int lj,int num){
	int i=0,j=0;
	int jw[4]={0,0,0,0};
...
void choosePlace(int s[SIZE][SIZE],int i,int j){
 ...
 //    if(aRecordBoard2[li][lj]!=0){
	// 	while(aRecordBoard[li][lj]!=0||!isOne(aRecordBoard2,li,lj,i)){
 //    	li=rand()%15;
 //    	lj=rand()%15;
 //    	}
	// }
...
void giving2Grades(int s[SIZE][SIZE]){
	...
	for(li=0;li<=14;li++)
			...
			for(m=0;m<=14;m++)
				for(n=0;n<=14;n++){
				if(aRecordBoard3[m][n]==0&&isFour(aRecordBoard3,m,n,(count+1)%2+1))
					board2[m][n].five=1000;

				if(aRecordBoard3[m][n]==0&&isFour(aRecordBoard3,m,n,(count)%2+1))
					board2[m][n].a4=999;

				if(aRecordBoard3[m][n]==0&&isThree(aRecordBoard3,m,n,(count+1)%2+1)&&!isFour(aRecordBoard3,m,n,(count+1)%2+1)&&!isHThree(aRecordBoard3,m,n,(count+1)%2+1))
					board2[m][n].four=200;

				if(aRecordBoard3[m][n]==0&&isHThree(aRecordBoard3,m,n,(count)%2+1))
					board2[m][n].ah3=900;

				if(aRecordBoard3[m][n]==0&&isThree(aRecordBoard3,m,n,(count)%2+1)&&!isHThree(aRecordBoard3,m,n,(count)%2+1))
					board2[m][n].a3=93;

				if(aRecordBoard3[m][n]==0&&isHThree(aRecordBoard3,m,n,(count+1)%2+1)&&!isFour(aRecordBoard3,m,n,(count+1)%2+1))
					board2[m][n].h3=998;

				if(aRecordBoard3[m][n]==0&&isTwo(aRecordBoard3,m,n,(count+1)%2+1)&&!isThree(aRecordBoard3,m,n,(count+1)%2+1)&&!isFour(aRecordBoard3,m,n,(count+1)%2+1))
					board2[m][n].three=190;

				if(aRecordBoard3[m][n]==0&&isTwo(aRecordBoard3,m,n,count%2+1))
					board2[m][n].a2=94;

				if(aRecordBoard3[m][n]==0&&isOne(aRecordBoard3,m,n,(count+1)%2+1)&&!isTwo(aRecordBoard3,m,n,(count+1)%2+1)&&!isThree(aRecordBoard3,m,n,(count+1)%2+1)&&!isFour(aRecordBoard3,m,n,(count+1)%2+1))
					board2[m][n].two=95;
				...
				board[li][lj].total2=board[li][lj].total-chosen2_total/4;
